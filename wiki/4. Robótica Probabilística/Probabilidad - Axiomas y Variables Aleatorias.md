...
## 1. Idea principal de la robótica probabilística  *(Teóricas 05-intro_robo_proba parte 1, slide 2)*
...
## 2. Axiomas de la probabilidad  *(Teóricas 05-intro_robo_proba parte 1, slides 3–5)*
...
## 3. Variables aleatorias discretas  *(Teóricas 05-intro_robo_proba parte 1, slide 6)*
...
## 4. Variables aleatorias continuas  *(Teóricas 05-intro_robo_proba parte 1, slide 7)*
...
## 5. Las probabilidades suman 1  *(Teóricas 05-intro_robo_proba parte 1, slide 8)*

| Caso discreto | Caso continuo |
|---|---|
| $\sum_x P(x) = 1$ | $\int p(x)\,dx = 1$ |

## 6. Probabilidad conjunta e independencia  *(Teóricas 05-intro_robo_proba parte 1, slide 9)*
$$P(X = x \text{ e } Y = y) = P(x, y)$$

Si $X$ e $Y$ son **independientes**:
$$P(x, y) = P(x)\,P(y)$$

## 7. Probabilidad condicional  *(Teóricas 05-intro_robo_proba parte 1, slide 10)*
...
## 8. Ley de la probabilidad total  *(Teóricas 05-intro_robo_proba parte 1, slide 11)*
...
## 9. Marginalización  *(Teóricas 05-intro_robo_proba parte 1, slide 12)*
...
## Fuentes
- `Raw/Diapositivas/Teoricas/05-intro_robo_proba-parte_1.pdf` — slides 2–12.
