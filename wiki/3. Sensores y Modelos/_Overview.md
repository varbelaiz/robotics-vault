...
## Conecta con
- ⬅️ [[1. Fundamentos/_Overview|Módulo 1: Fundamentos]] (matrices, atan2, gaussianas)
- ⬅️ [[2. Locomoción/_Overview|Módulo 2: Locomoción]] (los encoders alimentan odometría)
- ➡️ [[4. Robótica Probabilística/_Overview|Módulo 4: Probabilidad]] (la base teórica de $p(z \mid x, m)$)
- ➡️ [[5. Filtros Bayesianos/_Overview|Módulo 5: Filtros Bayesianos]] (los filtros consumen los modelos de sensor)
- ➡️ [[6. Mapeo/_Overview|Módulo 6: Mapeo]] (likelihood field se computa desde mapa de ocupación)
