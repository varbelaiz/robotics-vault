...
## 2. GNSS-RTK (Real-Time Kinematics)
...
## 3. Sensores de ultrasonido (sonar)
...
## 4. Propiedades y errores del ultrasonido
...
## 5. Sensor de triangulación óptica
...
## 7. Cámara de luz estructurada (RGBd / Kinect)
...
## Fuentes
- `Raw/Diapositivas/Teoricas/04-sensores-3.pdf`
  - slide 10 → 1. GNSS (Global Navigation Satellite System)
  - slide 11 → 2. GNSS-RTK (Real-Time Kinematics)
  - slides 12–13 → 3. Sensores de ultrasonido (sonar)
  - slides 14–17 → 4. Propiedades y errores del ultrasonido
  - slide 18 → 5. Sensor de triangulación óptica
  - slides 19–22 → 6. Escáner láser (LiDAR)
  - slide 25 → 7. Cámara de luz estructurada (RGBd / Kinect)
  - slide 27 → 8. Cámara estéreo